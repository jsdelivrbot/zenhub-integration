...
function moveIssue(issue_number, pipelineName, repo_id, position) {
  ...
  var access_token =
    "8055b53733419dd4147b42f6f9389764003173fbb7d53e469738a1abaed7335928ec6648e36579a3";
  ...
  return axios
    ...
    .then(res => {
      if (res.data && res.data.pipelines) {
        ...
        if (pipline_id === "")
          return Promise.resolve({
            success: false,
            error: "could not find pipeline " + pipelineName
          });
      ...
      return Promise.resolve({
        success: false,
        error: "Could not get board information"
      });
    })
